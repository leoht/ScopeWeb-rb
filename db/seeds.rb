...
ville_category = NoticeCategory.create(title: 'Ville expressioniste', nicename: 'themes_ville', parent: themes_category)
ville_machine_category = NoticeCategory.create(title: 'Ville machine', nicename: 'themes_ville_machine', parent: themes_category)
double_category = NoticeCategory.create(title: 'Thème du double', nicename: 'themes_double', parent: themes_category)
temps_category = NoticeCategory.create(title: 'Le temps', nicename: 'themes_temps', parent: themes_category)
sf_category = NoticeCategory.create(title: 'Science-Fiction', nicename: 'themes_sf', parent: themes_category)
...
movie.notices.create(title: 'C-3PO', timecode: '2400', end_timecode: '2475', short_content: 'Le design de C-3PO dans Star Wars possède une troublante ressemblance avec l’androïde.', content: '', category: cinema_category, teasing: 'Le design de C3PO dans Star Wars possède une troublante ressemblance avec un personnage du film...')
...
# IMPACT / MUSIQUE
movie.notices.create(title: 'Madonna', timecode: '240', short_content: 'Le vidéo-clip Express Yourself de Madonna réalisé par David Fincher en 1989 reprend l’intrigue du film ainsi que certains décors (la ville haute, la ville basse, la machine actionnée par les ouvriers...).', content: '', category: music_category)
...
movie.notices.create(title: 'Final Fantasy XII', timecode: '570', end_timecode: '700', short_content: 'Le jeu vidéo Final Fantasy XII s’est inspiré du régime social mis en place dans Métropolis pour construire l’histoire de la ville d’Archadès.', content: '', category: games_category)
...
movie.notices.create(title: '1000 figurants au crâne rasé', timecode: '3034', short_content: 'Mille figurants ont eu le crâne rasé et ont tiré une maquette en parpaing à travers le Volkspark Rehberge de Berlin. La tour elle-même a été construite en modèle réduit.', category: secrets_category, teasing: 'Près de 1000 figurants ont été nécessaire pour tourner une séquence.')
